...
WANDB_PROJECT=datacomp1b-images-128threads
IMAGE_ROOT="s3://${WANDB_PROJECT}-112324-${NODE_COUNT}nodes"
...
python3 -m download_aws \
    ...
    --save_additional_columns "'clip_b32_similarity_score,clip_l14_similarity_score,face_bboxes'" \
    --local False \
    --processes_count 16 \
    --thread_count 128 \
    --enable_wandb True \
